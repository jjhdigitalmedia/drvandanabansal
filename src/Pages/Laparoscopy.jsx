...
const Laparoscopy = () => {
  return (
    <div className='w-11/12 md:w-1/2 m-auto pt-40 pb-24'>
      <h1 className='font-bold text-3xl my-3'>Laparoscopy</h1>
      ...
      <p className='my-3' >This procedure involves inserting a small telescope known as a laparoscope through the abdominal wall when the pelvic organs can be clearly seen. A laparoscopy is performed in the operating theatre, usually as a day-case under a general anaesthetic. Laparoscopy is performed to inspect the uterus, tubes and ovaries for the presence of adhesions. Other pelvic problems such as Hydrosalpinx, Pelvic TB, Endometriosis and Fibroid can also be detected.</p>
    </div>
  )
}
