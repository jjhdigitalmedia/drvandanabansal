          ...
          <form onSubmit={onSubmit} className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-1/2">
              <div className="relative">
                ...
                <input type="email" id="email" name="email" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-rose-700 focus:bg-white focus:ring-2 focus:ring-rose-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
            </div>
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-rose-500">bansal.drvandana@gmail.com</a>
