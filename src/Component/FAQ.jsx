        ...
        <>
            <div className="">
                ...
                <div className=" text-center m-auto rounded-3xl faq" >
                    <Accordion className="border-2 border-none my-2 rounded-2xl px-3 border-b-slate-600 bg-gradient-to-r from-pink-200" data-aos='fade-up' open={open === 1} icon={<Icon id={1} open={open} />}>
                    ...
                    <Accordion className=" border-2 border-none my-2 rounded-2xl px-3 border-b-slate-600 bg-gradient-to-r from-pink-200" data-aos='fade-up' open={open === 2} icon={<Icon id={2} open={open} />}>
                    ...
                    <Accordion className=" border-2 border-none my-2 rounded-2xl px-3 border-b-slate-600 bg-gradient-to-r from-pink-200" data-aos='fade-up' open={open === 3} icon={<Icon id={3} open={open} />}>
                    ...
                    <Accordion className=" border-2 border-none my-2 rounded-2xl bg-gradient-to-r from-pink-200 px-3 border-b-slate-600" open={open === 4} data-aos='fade-up' icon={<Icon id={4} open={open} />}>
                    ...
                    <Accordion className=" border-2 border-none my-2 rounded-2xl bg-gradient-to-r from-pink-200 px-3 border-b-slate-600" data-aos='fade-up' open={open === 5} icon={<Icon id={5} open={open} />}>
                    ...
                    <Accordion className=" border-2 border-none my-2 rounded-2xl px-3 border-b-slate-600 bg-gradient-to-r from-pink-200" data-aos='fade-up' open={open === 6} icon={<Icon id={6} open={open} />}>
