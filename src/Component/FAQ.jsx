        ...
        <>
            <div className="">
                ...
                <div className=" text-center m-auto rounded-3xl faq" >
                    <Accordion className="border-2 text-justify px-4 hover:bg-rose-200 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 1} icon={<Icon id={1} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(1)}>What is infertility?</AccordionHeader>
                        <AccordionBody >
                            Infertility is defined as the inability to conceive a child despite trying for one year.
                        </AccordionBody>
                    </Accordion>
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-200 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 2} icon={<Icon id={2} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(2)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-200 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 3} icon={<Icon id={3} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(3)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-200 border-none my-1 rounded-xl bg-gradient-to-r from-rose-200 border-b-slate-600" open={open === 4} data-aos='fade-up' icon={<Icon id={4} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(4)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-200 border-none my-1 rounded-xl bg-gradient-to-r from-rose-200 border-b-slate-600" data-aos='fade-up' open={open === 5} icon={<Icon id={5} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(5)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-100 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 6} icon={<Icon id={6} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(6)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-100 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 7} icon={<Icon id={7} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(7)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-100 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 8} icon={<Icon id={8} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(8)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-100 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 9} icon={<Icon id={9} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(9)}>
                    ...
                    <Accordion className=" border-2 text-justify px-4 hover:bg-rose-100 border-none my-1 rounded-xl border-b-slate-600 bg-gradient-to-r from-rose-200" data-aos='fade-up' open={open === 10} icon={<Icon id={10} open={open} />}>
                        <AccordionHeader className="text-xs md:text-sm py-3" onClick={() => handleOpen(10)}>
