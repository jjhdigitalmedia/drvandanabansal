      ...
      <div className="container mx-auto  flex px-5 py-10 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-8 md:pl-8 flex flex-col md:item zs-start md:text-left items-center text-center">
          ...
          <div className='text-justify' >
            <span>1. Age: </span> Age is one of the most significant factors
            affecting IVF success. Generally, the younger the woman, the higher
            the chances of success, as fertility declines with age.
          </div>
          <div className='text-justify' >
            <span>2. Cause of Infertility: </span> The underlying cause of infertility, whether it's related to issues with the woman's reproductive system, the man's reproductive system, or both, can impact IVF success rates.
          </div>
          <div className='text-justify' >
            <span>3. Ovarian Reserve: </span>  The quality and quantity of a woman's eggs, known as ovarian reserve, can affect the success of IVF. Women with a higher ovarian reserve typically have better outcomes.
          </div>
          <div className='text-justify' >
            <span>4. Response to Ovarian Stimulation:</span> The woman's response to ovarian stimulation medications, which are used to induce the development of multiple eggs, can influence IVF success. A poor response may result in fewer eggs retrieved, affecting the chances of success.
          </div>
          <div className='text-justify' >
            <span>5. Semen Quality: </span> The quality of the man's sperm, including parameters such as sperm count, motility, and morphology, plays a crucial role in IVF success. Poor semen quality can decrease the chances of fertilization and embryo development.
          </div>
          <div className='text-justify' >
            <span>1. Age: </span> Age is one of the most significant factors
            affecting IVF success. Generally, the younger the woman, the higher
          ...
          <div className='text-justify' >
            <span>6. Embryo Quality: </span> The quality of embryos transferred during IVF, as determined by their morphology and developmental stage, is a significant predictor of success. Higher-quality embryos have a better chance of implanting and resulting in a successful pregnancy.
          </div>
