    ...
    return (
        <>
            ...
            <div className='text-center pt-20'>
                ...
                <div className='m-auto bg-red-100 w-fit mb-2 p-1'> <span className='mb-2'>Book Your Appointment - </span>
                    <div className="relative inline-flex">
                        <button
                            ...
                            6390103002                    </button>
                        <span
                            className="absolute min-w-[25px] min-h-[25                              px] rounded-full py-1 px-1 text-xs font-medium content-[''] leading-none grid place-items-center top-[4%] right-[2%] translate-x-2/4 -translate-y-2/4 bg-rose-700 text-white">
                        </span>
                    </div>
                </div>
