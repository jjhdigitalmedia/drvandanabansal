...
const Appointment = () => {
  return (
    <div className="bg-zinc-300 flex flex-wrap md:px-16 md:py-10 w-full m-auto ">
      <div className=" text-left md:w-1/2 w-full py-10 px-10">
        <h1 className=' text-2xl text-centre md:text-4xl mb-2 text-gray-700 font-bold'>Request an Appointment</h1>
