...
const About = () => {
    return (
        <>
            <section id='about' class="text-gray-600 w-full  mt-14 body-font">
                ...
                <div class="container mx-auto  flex px-5 py-8 md:flex-row flex-col items-center">
                    <div class="p-5 md:w-1/2 w-5/6 ">
                        <img class=" object-cover object-center rounded-2xl" alt="hero" src={aboutvandana} />
                    </div>
                    <div class="lg:flex-grow md:w-1/2 lg:pl-8 md:pl-8 flex flex-col md:items-start text-center md:text-left items-center ">
                        <h1 class="title-font sm:text-4xl text-3xl md:mb-2 font-medium text-gray-900"> Dr. Vandana Bansal
                        </h1>
                        ...
                        <p class="mb-8 md:text-left text-sm leading-relaxed"> DR. VANDANA BANSAL – MBBS, DGO, MS, D.Phil (Gold Medalist) FCGP is one of the renowned and Senior Gynaecologists and Obstetricians of the state of Uttar Pradesh. She is specialized in Laparoscopy and Hysteroscopic Surgery – since 18 years. Besided, she is Director of 500-bedded, multi-speciality Jeevan Jyoti Hospital, Arpit Test Tube Baby Centre & Vandana Women’s Hospital Allahabad. Jeevan Jyoti Hospital has completed 25th years in Oct-2013 Silver Jubilee celebration.</p>
                        <div class="flex justify-center">
                            <Link to='bookappointment'>
                                <button class="inline-flex text-white bg-rose-700 border-0 py-2 px-6 focus:outline-none hover:bg-rose-800 rounded text-sm">Book Appoinment</button>
                            </Link>
                        </div>
                    </div>
                </div>
